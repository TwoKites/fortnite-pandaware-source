...
namespace SDK
{
	...
	namespace Classes
	{
		namespace StaticOffsets {
			...
			uintptr_t SquadID = 0x105C;

			uintptr_t ProjectileGravityScale = 0x10c;

			uintptr_t bIsDying = 0x540;
			uintptr_t bIsDBNO = 0x58E;
			uintptr_t ReviveFromDBNOTime = 0x35E0;
			...
			uintptr_t LastFireTimeVerified = 0x9F0;//0x900;

			uintptr_t ReloadTime = 0x10C;
			uintptr_t LastReloadTime = 0xA24;
			uintptr_t LastSuccessfulReloadTime = 0xA28;

			uintptr_t bAlreadySearched = 0xE39;

			uintptr_t bADSWhileNotOnGround = 0x3B81;
	...
	namespace Utilities {
		...
		Structs::Vector3 SmoothAngles(Structs::Vector3 rot1, Structs::Vector3 rot2)
		{
			...
			ret.x = (rot2.x - rot1.x) / Settings.Aimbot.Smoothness + rot1.x;
			ret.y = (rot2.y - rot1.y) / Settings.Aimbot.Smoothness + rot1.y;
