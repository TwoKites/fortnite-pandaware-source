...
bool ImGui::Tab(unsigned int index, const char* label, int* selected, float width)
{
...
bool ImGui::SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
{
	...
	window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x - 3, frame_bb.Min.y + 3.25), ImVec2(grab_bb.Max.x - 3, grab_bb.Max.y), GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab), style.GrabRounding);
	window->DrawList->AddRectFilledMultiColor(ImVec2(frame_bb.Min.x - 3, frame_bb.Min.y + 3.25), ImVec2(grab_bb.Max.x - 3, grab_bb.Max.y), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)));
